  ...
  return (
    <main className="cv-page">
      ...
      <header className="cv-hero">
        ...
        <h1 className="cv-title">
          Mon ODYSSEE <br /><span>Cas pratique</span>
        </h1>

        <p className="cv-subtitle">
          Mon portfolio · Logique métier · UX immersive.<br />
    ...
    <Link to="/projects" className="cv-glass-link">
      ← Retour à Mes Projets
            ...
            <a
              href="/Cas_pratique_portfolio.pdf"
              target="_blank"
      ...
      <section className="cv-wrapper">
        <div className="cv-frame">
          <iframe
            src="/Cas_pratique_portfolio.pdf#toolbar=0&navpanes=0&scrollbar=0"
            title="Cas pratique Mon ODYSSEE"
            className="cv-iframe"
          />
        </div>
      </section>
